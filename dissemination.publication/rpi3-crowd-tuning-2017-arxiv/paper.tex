...
%\title{Open research SDK to build self-optimizing computer systems\\with the help of the Raspberry Pi community}
%\title{Open research SDK to collaboratively learn\\how to build self-optimizing computer systems}
%\title{Open SDK to research self-optimizing computer systems\\with the help of Raspberry Pi community and volunteers}

%\title{Open research SDK to learn how to build\\self-optimizing computer systems}
%\title{Open research SDK to build self-optimizing computer systems\\}

%\title{Collective Knowledge workflow to collaboratively research\\self-optimizing computer systems}

%\title{Collective Knowledge workflow to collaboratively research\\autotuning techniques across Raspberry Pi and other devices}



%\title{A Collective Knowledge workflow for collaborative research into\\multi-objective autotuning and crowdtuning techniques}
