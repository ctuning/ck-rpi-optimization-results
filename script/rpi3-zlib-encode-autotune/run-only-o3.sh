...
ck autotune program:zlib --repetitions=3 --scenario=experiment.tune.compiler.flags --extra_tags=main-flags \
   ...
   --cmd_key=encode --quiet --repeat=10 --dataset_uoa=video-raw-0001 --record_uoa=rpi3-zlib-encode-gcc4-main-o3 @run-only-o3.json

ck autotune program:zlib --repetitions=3 --scenario=experiment.tune.compiler.flags --extra_tags=main-flags \
   --new --skip_collaborative --skip_pruning \
   --compiler_env_uoa=4f11abfefd3cc031 \
   --cmd_key=encode --quiet --repeat=10 --dataset_uoa=video-raw-0001 --record_uoa=rpi3-zlib-encode-gcc7-main-o3 @run-only-o3.json

ck autotune program:zlib --repetitions=3 --scenario=experiment.tune.compiler.flags --extra_tags=main-flags \
   --new --skip_collaborative --skip_pruning \
   --compiler_env_uoa=8e66a1d34e9e93ea \
   --cmd_key=encode --quiet --repeat=10 --dataset_uoa=video-raw-0001 --record_uoa=rpi3-zlib-encode-clang381-main-o3 @run-only-o3.json
